using Employee_Management.EMS.Models;

namespace Employee_Management.EMS.Repository
{
...
Two sets of employees with the same first and last name:

One set employees have the same first and last name and hire date:

Five employees with the same first name:

Eight employees with the same last name:

Ten groups comprised of thirty employees sharing hire dates. Group size differs

Fifty total employees.
*/
